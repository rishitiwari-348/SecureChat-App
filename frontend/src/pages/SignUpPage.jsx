...
import { EyeIcon, EyeOffIcon, GithubIcon, LoaderIcon, LockIcon, MailIcon, MessageCircleHeartIcon, ShieldCheckIcon, SparklesIcon, UserIcon } from "lucide-react";
...
function SignUpPage() {
  ...
  const { signup, isSigningUp, continueWithOAuth, oauthLoadingProvider, resetOAuthLoading } = useAuthStore();
        ...
        <div className="relative grid min-h-[780px] lg:grid-cols-[1.05fr_0.95fr]">
          <div className="flex items-center justify-center p-6 sm:p-8 lg:p-10">
            <div className="w-full max-w-md animate-[fadeIn_250ms_ease-out]">
              <div className="mb-8 flex items-center gap-3">
                ...
                <div>
                  <p className="text-[11px] font-medium uppercase tracking-[0.32em] text-cyan-300">Nebula Chat</p>
                  <p className="text-sm text-slate-400">Secure. Fast. Private.</p>
                </div>
              </div>

              <div className="mb-8">
                <h1 className="text-3xl font-semibold tracking-tight text-slate-50 sm:text-4xl">Create your account</h1>
                <p className="mt-3 text-sm leading-7 text-slate-400 sm:text-[15px]">Join a workspace shaped for momentum, elegance, and effortless collaboration.</p>
              </div>

              <form onSubmit={handleSubmit} className="space-y-5" noValidate>
                <div className="group relative">
                  <label htmlFor="signup-fullname" className="mb-2 block text-sm font-medium text-slate-300">Full name</label>
                  <div className="relative rounded-2xl border border-white/[0.10] bg-white/[0.04] px-3 py-3 transition-all duration-200 focus-within:border-cyan-400/40 focus-within:bg-white/[0.06] focus-within:shadow-[0_0_0_1px_rgba(34,211,238,0.25),0_0_40px_rgba(34,211,238,0.12)]">
                    <UserIcon className="pointer-events-none absolute left-3.5 top-1/2 h-4 w-4 -translate-y-1/2 text-slate-500 transition-colors duration-200 group-focus-within:text-cyan-300" />
                    <input
                      id="signup-fullname"
                      type="text"
                ...
                <div className="group relative">
                  <label htmlFor="signup-email" className="mb-2 block text-sm font-medium text-slate-300">Email</label>
                  <div className="relative rounded-2xl border border-white/[0.10] bg-white/[0.04] px-3 py-3 transition-all duration-200 focus-within:border-cyan-400/40 focus-within:bg-white/[0.06] focus-within:shadow-[0_0_0_1px_rgba(34,211,238,0.25),0_0_40px_rgba(34,211,238,0.12)]">
                ...
                <div className="group relative">
                  <label htmlFor="signup-password" className="mb-2 block text-sm font-medium text-slate-300">Password</label>
                  <div className="relative rounded-2xl border border-white/[0.10] bg-white/[0.04] px-3 py-3 transition-all duration-200 focus-within:border-cyan-400/40 focus-within:bg-white/[0.06] focus-within:shadow-[0_0_0_1px_rgba(34,211,238,0.25),0_0_40px_rgba(34,211,238,0.12)]">
                ...
                <button className="group relative flex w-full items-center justify-center overflow-hidden rounded-2xl border border-cyan-400/20 bg-gradient-to-r from-cyan-400/90 via-cyan-500/90 to-indigo-500/90 px-4 py-3.5 font-semibold text-white shadow-[0_16px_45px_rgba(34,211,238,0.22)] transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[0_18px_55px_rgba(34,211,238,0.28)] disabled:cursor-not-allowed disabled:opacity-70" type="submit" disabled={isSigningUp}>
                  ...
                  {isSigningUp ? <LoaderIcon className="h-5 w-5 animate-spin" /> : <span className="relative flex items-center gap-2">Create account <SparklesIcon className="h-4 w-4" /></span>}
                </button>
              </form>
              ...
              <p className="mt-6 text-sm text-slate-400">
                Already part of the crew? <Link to="/login" className="font-medium text-cyan-300 transition-colors hover:text-cyan-200">Sign in</Link>
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center justify-center border-t border-white/[0.08] bg-slate-950/25 p-4 sm:p-6 lg:border-l lg:border-t-0 lg:p-8">
            <div className="w-full max-w-xl animate-[fadeIn_260ms_ease-out]">
              <AuthVisual
                eyebrow="Crafted for teams"
                title="Bring your ideas into focus."
                description="From launch-day collaboration to everyday conversation, everything feels smoother, clearer, and more intentional."
                bullets={["Instant onboarding", "Beautiful experience", "Trusted privacy"]}
              />
            </div>
          </div>
        </div>
